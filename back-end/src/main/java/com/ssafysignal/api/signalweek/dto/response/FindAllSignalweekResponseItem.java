...
public class FindAllSignalweekResponseItem {
    ...
    public static FindAllSignalweekResponseItem fromEntity(final Signalweek signalweek) {
        return FindAllSignalweekResponseItem.builder()
