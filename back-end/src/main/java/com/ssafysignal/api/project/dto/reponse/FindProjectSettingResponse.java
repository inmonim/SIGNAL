...
public class FindProjectSettingResponse {
    ...
    private List<FindProjectSettingDto> position;

    public static FindProjectSettingResponse fromEntity(final Project project){
        return FindProjectSettingResponse.builder()
                ...
                .position(project.getProjectPositionList().stream()
                        .map(FindProjectSettingDto::fromEntity)
